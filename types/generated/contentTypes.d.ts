...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    blog: Schema.Attribute.RichText & Schema.Attribute.Required;
...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    meet_request: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEditorsPickEditorsPick extends Struct.CollectionTypeSchema {
  collectionName: 'editors_picks';
  info: {
    displayName: 'editors-pick';
    pluralName: 'editors-picks';
    singularName: 'editors-pick';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    clients: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    portfolio: Schema.Attribute.RichText & Schema.Attribute.Required;
    project_description: Schema.Attribute.Text & Schema.Attribute.Required;
    project_overview: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    team_size: Schema.Attribute.String & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
